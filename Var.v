...
From SLF (* TLC *) Require Export LibString LibList LibCore.
From SLF (* Sep *) Require Import Fmap TLCbuffer.
...
Notation "''bk'" := ("bk":var) : var_scope.
Notation "''bk1'" := ("bk1":var) : var_scope.
Notation "''bk2'" := ("bk2":var) : var_scope.
Notation "''be'" := ("be":var) : var_scope.
Notation "''lb'" := ("lb":var) : var_scope.
Notation "''lb1'" := ("lb1":var) : var_scope.
Notation "''lb2'" := ("lb2":var) : var_scope.
Notation "''ln'" := ("ln":var) : var_scope.
Notation "''ln1'" := ("ln1":var) : var_scope.
